...
func NewSchemaIndexHandler(projects database.ProjectRepo, progress database.SchemaIndexProgressRepo, dropper CollectionDropper) *SchemaIndexHandler {
	return &SchemaIndexHandler{projects: projects, progress: progress, dropper: dropper}
}
