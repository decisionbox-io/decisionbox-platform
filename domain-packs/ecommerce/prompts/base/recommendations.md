...
### Priority Scale (1 = highest, 4 = lowest — emit as an integer, NOT a string):
...
- **4 (Low)**: Nice to have. Small improvement, minor optimization.
