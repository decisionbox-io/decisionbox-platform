...
- Connect to BigQuery, Amazon Redshift, Snowflake, or Databricks
...
- [Configuring Warehouses](guides/configuring-warehouse.md) — BigQuery, Redshift, Snowflake, Databricks setup
