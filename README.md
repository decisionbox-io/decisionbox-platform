...
1. **Connect** your data warehouse (BigQuery, Redshift, Snowflake, Databricks, and more)
...
- **Multiple warehouses** — BigQuery, Amazon Redshift (serverless + provisioned), Snowflake, Databricks
